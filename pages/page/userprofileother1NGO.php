...
if(isset($_SESSION['blocked_ngo'])){
	
	echo "<script type='text/javascript'>alert('User blocked')</script>";
	$_SESSION['blocked_ngo'] = false;
	unset($_SESSION['blocked_ngo']);
	   }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
				...
				<div class="form-group">
						...
						<!--/col-->
						<a   href="block.php?nid=<?php echo $c; ?>" class="btn btn-danger" style="margin-bottom:10px">Block this NGO</a>
	 <div class="row">
                <div class="col-lg-6"style="margin-left:300px;margin-top:-352px ;width:70%";>
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab" class="sidebarlinkcolor" >INFO</a>
                                </li>
						...
						<div id="DIV_25";>
							...
							<p id="P_100">
                                ...
                                <div class="tab-pane fade" id="messages">
									...
									?>
                                    <p><h4><?php echo"Category:" ; echo $row3['category']; ?></h4></p>
									<p><?php echo "Details : ";echo $row3['details']; ?></p>
									<p><?php echo "Posted on : ";echo $row3['date1']; ?></p>
									<hr>
									<?php }?>
                                </div>
				 ...
				 <a href="complaintformngo.php" button type="button" class="btn btn-outline btn btn-danger btn-lg btn-block" >To file a complaint against NGO please click here</a>
