    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">List of all NGOs</h1>
						  ...
						  <div >
							<div class="media" >
								...
								<div class="media-body">
									...
									if(mysqli_num_rows($resultngo)==0)
									{
									echo "<script type='text/javascript'>alert('there were no ngo's near by you')</script>";
									}
									$i=0;
									...
									$headstart2="userprofileother1NGO.php?nid=".$id;
									else
									$headstart2="userprofileotherNGO.php?nid=".$id;
									?>
