    ...
    <div id="wrapper">
	 ...
	 <div class="row">
                <div class="col-lg-6"style="margin-left:300px;margin-top:-300px ;width:70%";>
						...
						<div id="DIV_25";>
							...
							<p id="P_100">
                                ...
                                <div class="tab-pane fade" id="messages">
									...
									?>
                                    <p><h4><?php echo $row3['category']; ?></h4></p>
									<p><?php echo "Details : ";echo $row3['details']; ?></p>
									<p><?php echo "Date posted : ";echo $row3['date1']; ?></p>
									<?php }?>
                                </div>
				 ...
				 <a href="complaintform.php" button type="button" class="btn btn-outline btn btn-danger btn-lg btn-block" >To file a complaint against NGO please click here</a>
