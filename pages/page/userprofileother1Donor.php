...
if(isset($_SESSION['blocked_donor'])){
	
	echo "<script type='text/javascript'>alert('User blocked')</script>";
	$_SESSION['blocked_donor'] = false;
	unset($_SESSION['blocked_donor']);
	   }
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
				...
				<div class="form-group">
						...
						<a   href="block.php?did=<?php echo $a; ?>" class="btn btn-danger"style="margin-bottom:10px">Block this Donor</a>
						...
						<div id="DIV_25";>
							...
							<p id="P_100">
                                ...
                                <div class="tab-pane fade" id="messages">
									...
									?>
                                    <p><?php echo"Category:" ; echo $row3['category']; ?></p>
