...
if(isset($_SESSION['complaint_ngo']) )	{	
	echo "<script type='text/javascript'>alert('Your complaint was posted successfully')</script>";
	$_SESSION['complaint_ngo'] = false;
	unset($_SESSION['complaint_ngo']);
	   }
?>
    ...
    <div id="wrapper">
										...
										<div class="col-md-6 row">
										   <form method = "post" action = "session/ngosubmit.php">
											...
											<div class="form-group col-lg-6">
												...
												<input type="" name="date1" class="form-control" id="" placeholder = "yyyy-mm-dd" required="required">
											</div>
											
																
											<div class="form-group col-lg-6">
												<label>Event Time</label>
												<input type="" name="time" class="form-control" id="" value="" required="required">
											</div>
											
											<div class="form-group col-lg-6">
												<label>Event venue</label>
												<input type="" name="venue" class="form-control" id="" value="" required="required">
											</div>			
                                            ...
                                            <div class="modal-footer">
                                                    <input type="submit" class="btn btn-primary" style="margin-top:40px";  name="submit" value="Save" />
                                                    <button type="button" class="btn btn-default"style="margin-top:40px" data-dismiss="modal">Close</button>
                                                </div> 
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
					...
					<form action="ngo_wall.php" method="post">
					   <p> Set Distance to filter your Posts according to kms .Default distance is 20kms! <br> <input type="number" name="maxdistance"  required="required" min="0" max="5000"/></p>
						</form>
                    <ul class="timeline ">
                    ...
                    if ($counter%2 != 0 && $distance <= $maxdist) { 
                        ...
                        echo "<button class=\"btn btn-primary \" onclick = \"updateSupp($post_id);\" id = \"supp_button\" type=\"button\" style=\"margin-top: 30px; margin-left: 3px;\">Claim Donation</button>";
                        	echo "<form action='location.php' method='POST'>";
								...
								echo "<input class=\"btn btn-primary \" type=\"submit\" style=\"margin-top: -53px; margin-left: 160px;\" value=\"View Location\">";
						echo "</form>";
                        echo "</div>";
                        echo "</li>";
						 $counter = $counter + 1;
                 ...
                 <div class="col-lg-4 parth-1">
                    <div class="panel panel-success"style="margin-top:60px;border-color:black";>
                        ...
                        $queryevent = "SELECT * FROM ngo_post ORDER BY ngo_post_id";
                                    ...
                                    $i = 0;
                                    while(($row = mysqli_fetch_assoc($resultevent) )&& $i<3) {
                                    $ngo_id = $row['ngo_id'];
